...
public abstract class LoadMoreContainerBase extends LinearLayout implements LoadMoreContainer {
    ...
    public void loadMoreFinish(boolean emptyResult, boolean hasMore) {
        loadMoreFinish(emptyResult,hasMore,true);
    }

    @Override
    public void loadMoreFinish(boolean emptyResult, boolean hasMore, boolean showHasMoreHint) {
        mLoadError = false;
        ...
        if (mLoadMoreUIHandler != null) {
            mLoadMoreUIHandler.onLoadFinish(this, emptyResult, hasMore,showHasMoreHint);
        }
    }
